export const coursesItems = [
  {
    ...
    platform: 'Udemy',
    description:
      'Design, test, and deploy secure Smart Contracts, and use the latest version of Ethereum and React development tools to create blockchain applications.',
  ...
  },
  {
    ...
    platform: 'Udemy',
    description:
      'Learn the latest frameworks and technologies, including Javascript ES6, React, Bootstrap 4 and MongoDB.',
  ...
  },
  {
    ...
    platform: 'Udemy',
    description:
      'Build real client apps with Angular, write clean and maintainable code and apply best practices when building Angular apps.',
  ...
  },
  {
    ...
    platform: 'Udemy',
    description:
      'Build, run and push your own custom Docker images and manage real world web applications with Docker',
  ...
  },
  {
    ...
    platform: 'edX',
    description:
      'Learn how to analyze data in Python using multi-dimensional arrays in NumPy, manipulate DataFrames in Pandas, use SciPy library of mathematical routines, and perform machine learning using Scikit-learn.',
  ...
  },
  {
    ...
    platform: 'Coursera',
    description:
      'Learn the technological side of the cryptocurrencies, and specially the Bitcoin.',
